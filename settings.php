...
<html>
    ...
    <body style="background-image: url(img/slide3.jpg); background-size:cover">
        <div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-4 col-xs-offset-4" style=" font-family:'Fraunces', serif;">
                        <h1 style="color:white; background-color:#357cb4; border-radius:0px 0px 0px 0px; font-family:Poppins; "><center>Change Password</center></h1>
