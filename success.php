                    ...
                    <div class="col-xs-12 text-center">
                        <div class="panel panel-primary" style="border-color:black;">
                            ...
                            <div class="panel-body" style="background-color: black; border-color:black; ">
                                <p style="color:white; font-family:'Fraunces', serif; font-size:20px">Your order is confirmed.<br> Thank you for shopping with us. <a href="products.php">Click here</a> to purchase any other item.</p>
                            </div>
                        </div>
                    </div>
                </div>
